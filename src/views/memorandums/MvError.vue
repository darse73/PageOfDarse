<template>
  <Contents>
    ...
    <template v-slot:main>
      ...
      <p>
        A・B・C・D・E・F・G・H・I
        はその他もろもろのディレクトリやファイルを簡略化して表したものです。
      </p>
      <p>
      ...
      <p>
        最初にカレントディレクトリをWORKSに移し、lsコマンドを使ってWORKSディレクトリの中にあるディレクトリやフォルダを確認します。<br />
        (この作業をするよりも、ls \Users\○○\PageOfDarse\WORKS
        の方が効率的だったのかも)
      </p>
      <p>
      ...
      <p>
        あれ、"パス ～
        へのアクセスが拒否されました。"ってエラー出た。なんでかいな。調べてみよう。
      </p>
      <p>
        すると、<a href="https://teratail.com/questions/135065"
          >https://teratail.com/questions/135065</a
        >
        に、「該当フォルダ内のファイルやサブフォルダを別のプロセスが開いている。
        場合が結構あり、今回の様なエラーメッセージになることがあります。」と書いてありました。
      </p>
      <p>
      ...
      <p>
        <br /><br />あくまでこのサイトはプログラミング初心者のクラゲのダースが、プログラミング上達のために備忘録として書いているものです。
      </p>
      <p>
